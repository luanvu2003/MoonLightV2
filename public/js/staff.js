...
function updateVietQrCode(amount) {
  ...
  qrImg.src = `https://img.vietqr.io/image/MB-0393203037-compact2.png?amount=${amount}&addInfo=${encodeURIComponent('MoonLight ' + orderCode)}&accountName=VU%20PHAM%20LUAN`;
}
...
function showReceiptModal(order, staffName) {
  ...
  setT('recPaymentMethod', order.paymentMethod === 'banking' ? 'MB Bank QR' : 'Tiền mặt');
