            ...
            <table class="admin-table">
                ...
                <tbody>
                    ...
                    ` : list.map(o => {
                        ...
                        if (isBanking) {
                            paymentPill = isPaid 
                                ? `<span class="payment-method-pill banking-paid"><i class="fas fa-circle-check"></i> Banking (Đã trả)</span>`
                                : `<span class="payment-method-pill banking-pending"><i class="fas fa-clock"></i> Chờ chuyển khoản</span>`;
    ...
    body.innerHTML = `
        <div class="order-detail-grid">
            ...
            <div class="order-info-card">
                ...
                <div class="order-info-row"><span>Tiền về tài khoản:</span><strong>${order.isPaid ? '<span style="color:#10b981">Đã Nhận</span>' : '<span style="color:var(--gold-light)">Chưa Nhận</span>'}</strong></div>
